...
from .views import RegisterUserAPIView, LoginUserAPIView, MyProfile, LogoutUserAPIView, UpdateMyProfileAPIView, ChangePasswordAPIView, UsersListAPIView, AddProfilePhotoAPIView
